...
public class EmailService {
	...
	public void sendmail(String name, String email, String random) throws AddressException, MessagingException {
		...
		Authenticator auth = new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("srivas8583@gmail.com", "pinal1234");
			}
		};
		...
		try {
			...
			msg.setFrom(new InternetAddress("srivas8583@gmail.com", "NoReply-Pinal"));

			msg.setReplyTo(InternetAddress.parse("srivas8583@gmail.com.com", false));
	...
	public void ticketSendMail(String string, String string2, Date date,Time time,String[] bookedSeats,int price,String email) throws AddressException, MessagingException {
		...
		try {
			...
			msg.setReplyTo(InternetAddress.parse("srivas8583@gmail.com", false));
